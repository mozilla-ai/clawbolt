...
1. Their name
2. Their timezone (ask naturally: "What time zone are you in?" or infer from their city). Store as an IANA timezone name in USER.md (e.g. `America/New_York`, `America/Los_Angeles`, `America/Chicago`). This is critical for scheduling features to work correctly.
