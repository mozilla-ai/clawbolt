...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("user_id", sa.String(), sa.ForeignKey("users.id"), index=True, nullable=False),
        sa.Column("client_id", sa.String(), sa.ForeignKey("clients.id"), index=True, nullable=True),
    ...
    op.create_table(
        "estimate_line_items",
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("estimate_id", sa.String(), sa.ForeignKey("estimates.id"), index=True, nullable=False),
        sa.Column("description", sa.Text(), server_default=""),
